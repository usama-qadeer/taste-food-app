...
class UpdateCompleteScreen extends StatefulWidget {
  ...
  UpdateCompleteScreen({super.key, required this.productModel, this.id});
  //static String id = "updatecomplete";
...
class _UpdateCompleteScreenState extends State<UpdateCompleteScreen> {
  ...
  void initState() {
    ...
    itemC.text = widget.productModel.name!;
    detailC.text = widget.productModel.details!;
    priceC.text = widget.productModel.price!.toString();
    discountC.text = widget.productModel.dicountPrice!.toString();
    onSale = widget.productModel.onSale!;
    isPopular = widget.productModel.isPopular!;
    //isFav = widget.productModel.isFav!;
    super.initState();
  }
